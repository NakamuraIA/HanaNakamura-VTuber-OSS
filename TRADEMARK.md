...
handled separately by this brand policy and by asset-specific license notices.

## You May

- fork the repository;
- modify the source code under AGPL-3.0-only;
- publish your modifications under AGPL-3.0-only;
- say your project is "based on Hana Agent OSS";
...
- `MyAgent, based on Hana Agent OSS`
- `Hana Agent OSS fork by <name>`
- `Custom assistant powered by Hana Agent OSS`
...
This policy is intended to keep forks and community work possible while
protecting the official character identity, project name and creator credit.
