...
@router.post("/api/image/generate", summary="Gerar uma imagem")
...
@router.post("/api/image/edit", summary="Editar uma imagem")
...
@router.post("/api/image/character/generate", summary="Gerar imagem da Hana")
...
@router.post("/api/image/character/edit", summary="Editar imagem da Hana")
