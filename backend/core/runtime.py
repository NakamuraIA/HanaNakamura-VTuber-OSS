...
from backend.core.executor import DeterministicExecutor
from backend.core.planner import StructuredPlanner
...
from backend.core.verifier import ToolVerifier
...
from backend.tools.reminder_tools import register_reminder_tools
from backend.tools.skill_tools import register_skill_tools
from backend.tools.script_tools import register_script_tools
from backend.tools.terminal_tools import register_terminal_tools
    ...
    def _register_builtin_capabilities(self) -> None:
        self.capabilities.register(
            CapabilityManifest(
                ...
                entrypoint={"kind": "python", "module": "backend.core"},
        ...
        self.capabilities.register(
            CapabilityManifest(
                ...
                entrypoint={"kind": "python", "module": "backend.tools.file_tools"},
        ...
        self.capabilities.register(
            CapabilityManifest(
                ...
                entrypoint={"kind": "python", "module": "backend.tools.memory_tools"},
                permissions={"risk": "medium", "requires_user_enable": False},
            )
        )
