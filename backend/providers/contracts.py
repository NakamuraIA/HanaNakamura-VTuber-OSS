...
class ProviderRequest:
    ...
    # Gerenciador MCP compartilhado pelo backend. Evita criar uma sessão nova
    # em cada tool call; chamadas internas sem tools podem deixar como None.
    ...
    # Image generation service (used by image tools registered for function-calling providers)
