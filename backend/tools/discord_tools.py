"""Discord notification outbox: let Hana DM Nakamura on Discord when SHE decides.
...
owner (Nakamura) mentioning her, and marks the entry delivered. This keeps the
...
def discord_notify(memory: Any, message: str) -> dict[str, Any]:
    """Queue a DM for the Discord bot to deliver to Nakamura (she gets mentioned).

    Hana calls this when she decides to ping Nakamura on Discord (e.g. after
